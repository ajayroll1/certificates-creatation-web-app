-- Create Tables for Certificates Database
-- Database: certificates (already created)
-- Run this in MySQL Workbench after selecting the 'certificates' database
...
-- Username: admin
-- Password: admin123 (will be updated by setup.php)
...
SELECT 'Tables: admins, certificates' AS info;
